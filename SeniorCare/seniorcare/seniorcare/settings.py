...
TWILIO_VERIFY_SERVICE_SID = 'VE1234567890abcdef'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR/ 'templates'   #TO LET DJANGO KNOWS THAT WE HAVE A NEW FOLDER FOR OUR TEMPLATES TELLING IT WHERE TO LOOK
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
